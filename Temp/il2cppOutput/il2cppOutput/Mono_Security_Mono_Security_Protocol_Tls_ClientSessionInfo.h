...
struct  ClientSessionInfo_t753  : public Object_t
{
	...
	ByteU5BU5D_t658* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t658* ___masterSecret_5;
};
struct ClientSessionInfo_t753_StaticFields{
