...
struct  ClientSessionInfo_t1282  : public Object_t
{
	...
	ByteU5BU5D_t551* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t551* ___masterSecret_5;
};
struct ClientSessionInfo_t1282_StaticFields{
