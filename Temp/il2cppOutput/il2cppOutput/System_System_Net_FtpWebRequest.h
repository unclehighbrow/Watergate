...
struct  FtpWebRequest_t1016  : public WebRequest_t1012
{
	...
	RemoteCertificateValidationCallback_t1015 * ___callback_15;
};
struct FtpWebRequest_t1016_StaticFields{
	...
	RemoteCertificateValidationCallback_t1015 * ___U3CU3Ef__amU24cache1C_16;
};
