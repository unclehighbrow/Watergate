...
struct RSAManaged_t709;

#include "mscorlib_System_Object.h"

// Mono.Security.Protocol.Tls.TlsClientSettings
struct  TlsClientSettings_t757  : public Object_t
{
	...
	X509CertificateCollection_t788 * ___certificates_1;
