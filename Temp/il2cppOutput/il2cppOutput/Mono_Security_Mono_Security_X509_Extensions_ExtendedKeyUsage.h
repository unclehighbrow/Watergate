...
struct  ExtendedKeyUsageExtension_t1259  : public X509Extension_t1166
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t998 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t1259_StaticFields{
	...
	Dictionary_2_t532 * ___U3CU3Ef__switchU24map14_4;
};
