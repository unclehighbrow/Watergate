...
struct  X509Store_t926  : public Object_t
{
	...
	X509Certificate2Collection_t920 * ___list_2;
	...
	X509Store_t726 * ___store_4;
};
struct X509Store_t926_StaticFields{
	...
	Dictionary_2_t244 * ___U3CU3Ef__switchU24mapF_5;
};
