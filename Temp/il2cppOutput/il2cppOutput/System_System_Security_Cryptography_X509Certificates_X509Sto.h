...
struct  X509Store_t1060  : public Object_t
{
	...
	X509Certificate2Collection_t1051 * ___list_2;
	...
	X509Store_t1074 * ___store_4;
};
struct X509Store_t1060_StaticFields{
	...
	Dictionary_2_t532 * ___U3CU3Ef__switchU24mapF_5;
};
