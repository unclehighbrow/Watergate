...
struct  X509Store_t1059  : public Object_t
{
	...
	X509Certificate2Collection_t1050 * ___list_2;
	...
	X509Store_t1073 * ___store_4;
};
struct X509Store_t1059_StaticFields{
	...
	Dictionary_2_t531 * ___U3CU3Ef__switchU24mapF_5;
};
