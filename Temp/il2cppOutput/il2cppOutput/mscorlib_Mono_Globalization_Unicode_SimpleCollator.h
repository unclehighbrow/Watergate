...
struct  SimpleCollator_t1410  : public Object_t
{
	...
	CodePointIndexer_t1397 * ___cjkIndexer_6;
	...
	CodePointIndexer_t1397 * ___cjkLv2Indexer_8;
...
struct SimpleCollator_t1410_StaticFields{
	...
	SimpleCollator_t1410 * ___invariant_1;
};
